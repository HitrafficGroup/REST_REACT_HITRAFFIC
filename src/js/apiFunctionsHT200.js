...
async function getPatternHT200(mac,ip) {
	var res;
	await axios.get(`${BASE_HT200}/rest/getPatternHT200?mac=${mac}&ip=${ip}`).then(response => {
		res = response.data
		Swal.fire({
			title: "Completado!",
			text: "Datos Leidos Con Éxito",
...
async function PostPatternHT200(jsonData) {
	await axios.post(`${BASE_HT200}/rest/setPatternHT200?mac=${jsonData['mac']}`,jsonData)
		.then(response => {
			console.log(response.data)
			Swal.fire({
				title: "Completado!",
...
async function getAccionHT200(mac,ip) {
	var res;
	await axios.get(`${BASE_HT200}/rest/getAccionHT200?mac=${mac}&ip=${ip}`).then(response => {
		res = response.data
		Swal.fire({
			title: "Completado!",
			text: "Datos Leidos Con Éxito",
...
async function PostActionHT200(jsonData) {
	await axios.post(`${BASE_HT200}/rest/setActionHT200?mac=${jsonData['mac']}`,jsonData)
		.then(response => {
			console.log(response.data)
			Swal.fire({
				title: "Completado!",
